 ...
 */
package com.crashnote.logger.test.unit.report

import com.crashnote.logger.test.defs.MockSpec
import com.crashnote.logger.report.LoggerReporter
import com.crashnote.logger.test.defs.stubs.ConfigStub
...
class LoggerReporterSpec
    ...
    "Logger Reporter" should {
        ...
        "decide whether to accept logs" >> {
            ...
            "when disabled" >> new Mocked(DISABLED) {
